...
<!-- Latest compiled and minified JavaScript -->
  <style>
	...
	#bar1,#bar2{
		border-bottom: 4px solid #00d4be;
  ...
  <script>
	const square = (number) => {
		...
		$("#buttonsearch").click(function(){
			...
			$("#head1").empty()
			$("#loading").empty();
			$("#loading").append("<center><img src='images/ZWdx.gif'/></center>");
			$("#bar1").hide();
			$("#bar2").hide();
			$("#news").empty();
			$("#news1").empty();
...
<div class="section">
	...
	<div class="container">
        ...
        <center>
			<div class="navbar-right hidden-lg hidden-md " style="margin-top:10px">
				<button class="btn btn-success" id="buttonsearch" type="submit" >
